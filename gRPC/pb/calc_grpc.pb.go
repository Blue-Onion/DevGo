...
type CalculatorClient interface {
	Add(ctx context.Context, in *CalculationReq, opts ...grpc.CallOption) (*CalculationRes, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *CalculationReq, opts ...grpc.CallOption) (*CalculationRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CalculationRes)
...
type CalculatorServer interface {
	Add(context.Context, *CalculationReq) (*CalculationRes, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *CalculationReq) (*CalculationRes, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*CalculationReq))
	}
